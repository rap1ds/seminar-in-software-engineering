...
For commercial products, the product owner is typically a customer representative \cite{2010pichler}. However, this is not a mandatory practice. Although the Product Owner is not always from customer organization, in this paper customer refers to Product Owner because she is ultimately the person who can answer the question "Is this the right thing to do for the customer?" \cite{2012sutherland}. 

Even though this paper focuses on feedback from Product Owner, I see no reason why the results of the paper would not apply to other stakeholders and customers. According agile process models the Product Owner is the teams window to the world, but in my own experience, there are always other stakeholders and customer organization members who are keen to express their opinnions by providing feedback to the developers.
