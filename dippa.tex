...
Despite the advantages of face-to-face communication it is also a costly communication method. Face-to-face communication is synchronous method which requires shared physical location. In software projects where customer is not on-site, other feedback methods than face-to-face have to be exercised.
