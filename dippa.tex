...
Dart et. al. have proposed a theory of media richness \cite{1986daft}. The media richness theory (MRT) is well-known and largely used even though it has been widely criticized \cite{2006korkala}. 

According to MRT the different communication methods can be ranked based on their "richness". Dart et. al. defines the richness as the ability of information to change understanding within a time interval. The richness is derived the capacity of immediate feedback, the number of cues and channels utilized, personalization and language variety. Dart et. al. lists the following media classifications in order of decreasing richness: face-to-face communication, telephone, personal documents, impersonal written documents and numberic documents. \cite{1986dart}
