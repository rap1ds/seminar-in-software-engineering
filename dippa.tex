...
Media synchronocity theory states that communication is composed of two primary processes: \textbf{conveyance} and \textbf{convergence}. Conveyance process exists when there is a need for transmission of a new information. The information receiver processed the new information and creates a mental model of the situation. Covergence process means discussing of the information processed by the individuals. The target is to change views of each interpretation and agree on mutual understanding. The individuals' familiarity with each other, the task they are performing and the communication media they are using affects to the relative amount of these two processes. For familiar communication context, the emphasis is on the conveyance process \cite{2008dennis}.
