...
Also Korkala et al noticed, that in their research the customers of the projects selected usually email as the main communication channel dispite the fact that they have been encouraged to use "richer" communication media \cite{2006korkala}. One reason for this could be that the customers subconsciously selected a communication media which in fact had the best performance (cost-value ratio).
